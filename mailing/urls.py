...
urlpatterns = [
    ...
    path(
        "messages/create_message/", MessageCreateView.as_view(), name="create_message"
    ),
    ...
    path(
        "mailings/create_mailing/", MailingsCreateView.as_view(), name="create_mailing"
    ),
    ...
    path(
        "mailings/<int:pk>/toggle/", toggle_mailing_active, name="toggle_mailing_active"
    ),
